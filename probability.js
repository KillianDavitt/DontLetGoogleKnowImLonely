 ...
 * @return {2d Array, Array}  1st object: row_probs; 2nd object: col_probs.
 */
function getProbs() {
 ...
 * @param  {2d Array} row_probs  Row probabilities.
...
function getPRI(ad, row_probs, col_probs) {
	...
	// /**/alert(word_freq.reduce((a,b) => a + b, 0));
	// /**/alert(total_words);
	var pri = [];
 ...
 * @return {2d Array}         Empty matrix (n_rows x n_cols).
 */
